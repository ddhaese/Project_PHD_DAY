...
In je nieuw Rmd bestand, verwijder je de voorbeeld code, i.e. alles vanaf `## R Markdown`. Maak dan een nieuw titeltje aan '## TODO: TITEL WIJZIGEN' met daarna een lege lijn. Druk dan op het icoontje om code-chunks in te voegen en kies in de keuzelijst voor R-code. Plak dan de gegenereerde code uit de console in deze code chunk zodat je de volgende twee chunks krijgt:
